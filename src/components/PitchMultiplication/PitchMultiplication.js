  ...
  return (
    <React.Fragment>
      <Container className="PitchMultiplication">
        ...
        <Row className="content">
          <p>
            In the flute line, from left to right, the pitch classes are (2, 10, 1, 11, 8, 7), corresponding to the notes (D B♭ D♭ B A♭ G). The image above is from the score of <i>Le Marteau sans Maître</i> provided by Alexander Street.<sup>10</sup>
          </p>
          <p>
      ...
      <Navbar bg="light" variant="light" expand="lg" className="Footer">
        <Container>
          8. Saman Samadi, “An Analytical Study on Pierre Boulez’s Le Marteau sans Maître,” Research Catalogue, September 28, 2020, https://www.researchcatalogue.net/view/718708/718709.
          <br/>
          9. Lev Koblyakov, Pierre Boulez : A World of Harmony (Reading: Harwood Academic Publishers, 1992), 3-5.
          <br/>
          10. Pierre Boulez, Le Marteau sans Maître, Universal Edition, 1964, https://search.alexanderstreet.com/view/work/bibliographic_entity%7Cscore%7C553558.
        </Container>
      </Navbar>
    </React.Fragment>
  );
