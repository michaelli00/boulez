    ...
    <React.Fragment>
      <Container className="PitchMultiplication">
        ...
        <Row className="content">
          <p>
            The idea behind pitch multiplication is to take two sets from a group of pitch class sets and "sum of every possible pairing between them".<sup>7</sup> Note that any duplicate pitch classes in the resulting set are removed. For example, let a = (1 2) and b = (3 4) be pitch class sets. Then the pitch multiplication of these two sets, denoted ab, yields (4 5 6). This comes from
          </p>
          <ul>
            <li> 1 + 3  = 4 </li>
            <li> 2 + 3  = 5 </li>
      ...
      <Navbar bg="light" variant="light" expand="lg" className="Footer">
        <Container>
          7. Saman Samadi, “An Analytical Study on Pierre Boulez’s Le Marteau sans Maître,” Research Catalogue, September 28, 2020, https://www.researchcatalogue.net/view/718708/718709.
          <br/>
          8. Lev Koblyakov, Pierre Boulez : A World of Harmony (Reading: Harwood Academic Publishers, 1992), 3-5.
          <br/>
          9. Pierre Boulez, Le Marteau sans Maître, Universal Edition, 1964, https://search.alexanderstreet.com/view/work/bibliographic_entity%7Cscore%7C553558.
        </Container>
      </Navbar>
    </React.Fragment>
  );
